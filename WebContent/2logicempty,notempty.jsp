	...
	<div class="container">
		...
		<div class="bs-example">
			<table class="table table-striped">
				...
				<tbody>									
					<!-- Kiểm tra listSinhVien có null hay không 
						1. property == null(empty).
						2. property !=null(empty). 
					-->
					<logic:empty name="danhSachSinhVienForm" property="listSinhVien">
						<h2>Danh sách trống</h2>
					</logic:empty>					
					<logic:notEmpty name="danhSachSinhVienForm" property="listSinhVien">
